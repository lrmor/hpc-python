...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_evolve_cmodule(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_evolve_cmodule(void) { return NULL; }
#  else
     initevolve_cmodule(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_evolve_cmodule(void)
{
  return _cffi_init("evolve_cmodule", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initevolve_cmodule(void)
{
  _cffi_init("evolve_cmodule", 0x2601, &_cffi_type_context);
}
#endif
